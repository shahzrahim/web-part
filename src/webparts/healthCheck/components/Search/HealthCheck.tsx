...
export default class HealthCheck extends React.Component<IHealthCheckProps,any> { 
  ...
  {    
    ...
    var resultsData =listResultsService.getApplicationValue(webURL,listName)
    console.log(resultsData);  
    var FinalDDLValuess=[];
    FinalDDLValuess.push(resultsData);
    let firstArray:string[];
    firstArray=FinalDDLValuess[0];
        console.log(firstArray);
        this.setState({ results: FinalDDLValuess });
